        ...
        <div class="relative hidden lg:block min-h-[700px]">
            ...
            <div class="relative z-10 flex flex-col items-center justify-start h-full px-10 pt-60 text-center">
                ...
                <p class="text-gray-700 mt-4 text-lg max-w-md leading-relaxed">
                    Login to your applicant account to apply for open positions and track your application status.
                </p>
            </div>
        </div>
            ...
            <div class="w-full">
                ...
                <form method="POST" action="{{ route('applicant.login.submit') }}" class="space-y-6">
                    ...
                    <p class="text-center text-gray-500 text-sm">
                        ...
                        <a href="{{ route('applicant.register') }}" class="text-green-600 hover:text-green-700 font-bold">
                            Register here
                        </a>
                    </p>
                </form>
