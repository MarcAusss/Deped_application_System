...
<body class="min-h-screen flex items-center justify-center p-5 bg-slate-50">
    ...
    <div class="login-card w-full max-w-7xl rounded-[35px] overflow-hidden grid grid-cols-1 lg:grid-cols-[3fr_2fr]">
        ...
        <div class="relative hidden lg:block min-h-[700px]">
            ...
            <div class="relative z-10 flex flex-col items-center justify-start h-full px-10 pt-60 text-center">
                <div class="w-32 h-32 rounded-full bg-white shadow-2xl flex items-center justify-center border border-white">
                    <img
                ...
                <p class="text-gray-700 mt-4 text-lg max-w-md leading-relaxed">
                    Create an account to apply for open positions and track your application status.
                </p>
            </div>
        </div>
            ...
            <div class="w-full">
                ...
                <div class="mb-10">
                    ...
                    <p class="text-gray-500 mt-3 text-lg">
                        Register to start applying for open positions
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('applicant.register.submit') }}" class="space-y-6">
                    ...
                    <p class="text-center text-gray-500 text-sm">
                        ...
                        <a href="{{ route('applicant.login') }}" class="text-green-600 hover:text-green-700 font-bold">
                            Login here
                        </a>
                    </p>
                </form>
